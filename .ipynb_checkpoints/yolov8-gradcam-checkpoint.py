...
class yolo_heatmap:
    def __init__(self, weight, device, method, layer, backward_type, conf_threshold, ratio, show_result, renormalize, task, img_size):
        ...
        #     dummy_input = torch.randn(1, 3, 640, 640).to(device).requires_grad_()
        #     try:
        #         hooks = ActivationsAndGradients(model, [layer], None)
        #         out = model(dummy_input)
        #         print(f"✅ Layer {i} ({layer}) works with GradCAM")
        #     except Exception as e:
        #         print(f"❌ Layer {i} ({layer}) failed with GradCAM: {e}")
...
def get_params():
    params = {
        'weight': '/home/rizqimrazhari/yolo-repghost/runs/train/yolov8-repghost/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/home/rizqimrazhari/yolo-repghost/data/test/images/rip-104_png.rf.5bf4b64b250f70829dcbe9414429f553.jpg', 'viz/repghost')
